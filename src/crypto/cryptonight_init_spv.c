...
const uint32_t cryptonight_init_shader[] = {
  ...
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_UINT_INPUT, PTR_INPUT_W9, PTR_INPUT, CONST_UINT_9,
  ...
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_UINT_INPUT, PTR_INPUT_W10, PTR_INPUT, CONST_UINT_10,
  (4 << 16) | OP_LOAD, TYPE_UINT, INPUT_W10, PTR_INPUT_W10,
  (5 << 16) | OP_SHIFT_RIGHT_LOGICAL, TYPE_UINT, NONCE_SR_8, NONCE, CONST_UINT_8,
  (7 << 16) | OP_BITFIELD_INSERT, TYPE_UINT, INPUT_W10_MOD, INPUT_W10, NONCE_SR_8, CONST_UINT_ZERO, CONST_UINT_24,
