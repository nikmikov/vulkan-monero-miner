...
// swap two 8-byte halves
  ...
  //(4 << 16) | OP_UCONVERT, TYPE_UINT2, VAL_DX_A, VAL_CX_SWAPPED, //VAL_DX_ULONG2,
  //(5 << 16) | OP_SHIFT_RIGHT_LOGICAL, TYPE_ULONG2, VAL_DX_ULONG2_SR16, VAL_CX_SWAPPED, /*VAL_DX_ULONG2,*/ CONST_UINT_32,
