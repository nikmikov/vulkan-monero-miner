...
const uint32_t cryptonight_init_shader[] = {
  ...
  // CONSTANTS
  (4 << 16) | OP_CONSTANT, TYPE_UINT, CONST_UINT_ZERO, 0, // 0U
  (4 << 16) | OP_CONSTANT, TYPE_UINT, CONST_UINT_ONE, 1, // 1U
  ...
  (4 << 16) | OP_TYPE_POINTER, TYPE_PTR_ARRAY_UINT_50, SC_BUFFER, TYPE_ARRAY_UINT_50,
  // input buffer
  (4 << 16) | OP_TYPE_STRUCT, TYPE_STRUCT_BUFFER_INPUT, TYPE_UINT, TYPE_ARRAY_UINT_50,
  (4 << 16) | OP_TYPE_POINTER, TYPE_PTR_UINT_BUFFER, SC_BUFFER, TYPE_UINT,   //type: [Buffer] uint*
  (4 << 16) | OP_TYPE_POINTER, TYPE_PTR_INPUT_BUFFER, SC_BUFFER, TYPE_STRUCT_BUFFER_INPUT,
  // output buffer
  ...
  (4 << 16) | OP_TYPE_POINTER, TYPE_PTR_BUFFER_OUTPUT, SC_BUFFER, TYPE_STRUCT_BUFFER_OUTPUT,

  // GLOBAL VARIABLES
  (4 << 16) | OP_VARIABLE, TYPE_PTR_UINT3_INPUT, GLOBAL_INVOCATION_ID, SC_INPUT,
  (4 << 16) | OP_VARIABLE, TYPE_PTR_INPUT_BUFFER, PTR_BUFFER_INPUT, SC_BUFFER,
  (4 << 16) | OP_VARIABLE, TYPE_PTR_BUFFER_OUTPUT, PTR_BUFFER_OUTPUT, SC_BUFFER,

  // MAIN
  (5 << 16) | OP_FUNCTION, TYPE_VOID, FUNC_MAIN, FNC_NONE, TYPE_FUNC_VOID,
  (2 << 16) | OP_LABEL, LABEL_MAIN,
  // get global invocation index
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_UINT_INPUT, PTR_GLOBAL_INVOCATION_X, GLOBAL_INVOCATION_ID, CONST_UINT_ZERO,
  (4 << 16) | OP_LOAD, TYPE_UINT, GLOBAL_INVOCATION_X, PTR_GLOBAL_INVOCATION_X,
  // get pointer to HASH_STATE array for current invocation
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_RT_ARRAY_ARRAY_UINT_50, PTR_OUTPUT, PTR_BUFFER_OUTPUT, CONST_UINT_ZERO,
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_ARRAY_UINT_50, PTR_HASH_STATE, PTR_OUTPUT, GLOBAL_INVOCATION_X,
  // pointer to input buffer
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_ARRAY_UINT_50, PTR_INPUT, PTR_BUFFER_INPUT, CONST_UINT_ONE,

  // copy 200 bytes of input hash to state buffer
  (3 << 16) | OP_COPY_MEMORY, PTR_HASH_STATE, PTR_INPUT,
  // get start nonce
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_UINT_BUFFER, PTR_START_NONCE, PTR_BUFFER_INPUT, CONST_UINT_ZERO,
  ...
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_UINT_BUFFER, PTR_HASH_STATE_W9, PTR_HASH_STATE, CONST_UINT_9,
  (4 << 16) | OP_LOAD, TYPE_UINT, HASH_STATE_W9, PTR_HASH_STATE_W9,
  (7 << 16) | OP_BITFIELD_INSERT, TYPE_UINT, INPUT_W9_MOD, HASH_STATE_W9, NONCE, CONST_UINT_24, CONST_UINT_8,
  // * 24 high bits of nonce into 24 low bits of word 10 of inpuit
  (5 << 16) | OP_ACCESS_CHAIN, TYPE_PTR_UINT_BUFFER, PTR_HASH_STATE_W10, PTR_HASH_STATE, CONST_UINT_10,
  (4 << 16) | OP_LOAD, TYPE_UINT, HASH_STATE_W10, PTR_HASH_STATE_W10,
  (5 << 16) | OP_SHIFT_RIGHT_LOGICAL, TYPE_UINT, NONCE_SR_8, NONCE, CONST_UINT_8,
  (7 << 16) | OP_BITFIELD_INSERT, TYPE_UINT, INPUT_W10_MOD, HASH_STATE_W10, NONCE_SR_8, CONST_UINT_ZERO, CONST_UINT_24,
  // store modifed w9 and w10 to hash state
